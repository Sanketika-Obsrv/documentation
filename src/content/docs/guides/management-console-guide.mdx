...
![Connectors List Page](/assets/obsrv_v2/connectors_page.png)
![Connector Detailed Page](/assets/obsrv_v2/connector_detailed_page.png)
...
![Dataset Creation](/assets/obsrv_v2/dataset_creation_file_upload.png)
...
![Ingestion Configuration](/assets/obsrv_v2/dataset_schema.png) 
...
![Processing Configuration](/assets/obsrv_v2/processing_configuration.png) 
...
![Storage Configuration](/assets/obsrv_v2/storage_configurations.png) 
...
![Live Dataset List](/assets/obsrv_v2/dataset_list.png) 
![Retired Dataset List](/assets/obsrv_v2/dataset_retire.png) 
...
![Infra Alerts](/assets/obsrv_v2/default_system_alerts.png) 
![Custom Alerts](/assets/obsrv_v2/custom_alerts.png) 
![Notification Channels](/assets/obsrv_v2/notification_channels.png) 
...
![Infra Metrics](/assets/obsrv_v2/infra_metrics.png) 
![Ingestion Metrics](/assets/obsrv_v2/ingestion_metrics.png) 
![Storage Metrics](/assets/obsrv_v2/storage_metrics.png) 
![Processing Metrics](/assets/obsrv_v2/processing_metrics.png) 
