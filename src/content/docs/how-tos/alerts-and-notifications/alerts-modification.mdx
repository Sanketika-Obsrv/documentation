...
- Edit the necessary configurations. For detailed guidance on configuring these options, please refer to [Creating the Alert Rule](/how-tos/alerts-and-notifications/notifications/alerts-notification-setup/#creating-the-alert-rule).
