...
:::note
For a basic guide on creating a custom notification template, refer to the [Notification Template Setup Guide](/how-tos/alerts-and-notifications/notification-template-setup/).
:::
