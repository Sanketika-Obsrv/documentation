...
Change `HTTP_PORT` here if `8080` is taken. It is a single variable because it feeds the nginx binding, the Keycloak redirect URI, and the console's own base URL together.
