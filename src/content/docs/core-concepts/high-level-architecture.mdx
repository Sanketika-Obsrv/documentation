...
![Obsrv in a box - Fuse together multiple layers](/assets/spaces-wQH6CjWe7oYABC4HCh4N-uploads-swHf7vV8u9wvP1R4zQ0O-1.png)

Following diagram explains the high level architecture of the Obsrv data platform

![Obsrv Data Platform](/assets/spaces-wQH6CjWe7oYABC4HCh4N-uploads-VKmuVbM7NK5vi7vZIsdM-2.png)
