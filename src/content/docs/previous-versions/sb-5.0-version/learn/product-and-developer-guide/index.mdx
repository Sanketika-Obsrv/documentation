...
![L0 Sunbird Obsrv Component View](/assets/L0\_View.png)

![High Level Sunbird Obsrv Component Overview](/assets/Component\_View.png)

![Data analytics architecture](/assets/DataPipeline BB HighLevel Diagram.png>)
