...
**Data collection at scale:** Perform seamless telemetry data collection from client apps using horizontally scalable apis.
...
This is enabled by the [Telemetry Service](/product-and-developer-guide/telemetry-service) component of the Obsrv building block
...
The [Data Pipeline](/product-and-developer-guide/data-pipeline) component of the building block is used to enable these capabilities
...
The quick-analysis capabilities, along with the readymade metrics and downloadable datasets are made available using the [Data Service](/product-and-developer-guide/data-service), [Report Service](/product-and-developer-guide/report-service), [Report Configurator](/product-and-developer-guide/report-configurator) and the [Summarisers](/product-and-developer-guide/summarisers). These components come together to enable a boquet of reporting services for the Sunbird Obsrv building block.
